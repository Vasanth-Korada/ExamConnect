...
import 'package:talent_connect/pages/all_archived_contests.dart';
import 'package:talent_connect/pages/archived-contest.page.dart';
import 'package:talent_connect/pages/ongoing-contest.page.dart';
            ...
            children: [
              Expanded(
                child: ListView.builder(
                  ...
                  itemCount: (widget.isArchived && widget.contestsCount == null)
                      ? 7
                      : snapshot.data.docs.length,
                  itemBuilder: (context, i) {
                    if (widget.showMore && i == 6) {
                    ...
                    var contestName = snapshot
                        .data.docs[length - i - 1].data()['exam_name'];
                    var examID =
                        snapshot.data.docs[length - i - 1].data()['exam_id'];
                    var examDuration = snapshot
                        .data.docs[length - i - 1].data()['exam_duration'];
                    var examMarks = snapshot
                        .data.docs[length - i - 1].data()['exam_marks'];
                    var examTotalQuestions = snapshot.data
                        .docs[length - i - 1].data()['exam_total_questions'];
                    var maxAttempts = snapshot
                        .data.docs[length - i - 1].data()['max_attempts'];
                    var keyUnlockCost = snapshot
                        .data.docs[length - i - 1].data()['key_unlock_cost'];
                    bool isArchived = snapshot
                        .data.docs[length - i - 1].data()['isActive'];
                    List<dynamic> questions = snapshot
                        .data.docs[length - i - 1].data()['questions'];
